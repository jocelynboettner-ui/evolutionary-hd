...
const CHANNELS_FIRST_ADDITION                  = safeRequire('./channels-first-addition');
...
const SYSTEM_PROMPT = [
    BASE_PROMPT,
    TENSE_INSTRUCTION,
    CENTER_PDF_ADDITIONS,
    SOURCE_MATERIAL_ADDITIONS,
    PROFILE_LINES_ADDITION,
    GATES_BODYGRAPH_ADDITION,
    GATES_BY_CENTER_MAPPING,
    CHANNELS_CONNECTIONS_ADDITION,
    CIRCUITS_ADDITION,
    INDIVIDUAL_CHANNELS_ADDITION,
    TRIBAL_CHANNELS_ADDITION,
    COLLECTIVE_CHANNELS_ADDITION,
    ADVANCED_INTERPRETATION_ADDITION,
    DEFINITION_TYPES_ADDITION,
    SPLIT_DEFINITION_ADDITION,
    TRIPLE_QUAD_DEFINITION_ADDITION,
    STRATEGIC_QUESTIONING_ADDITION,
    LAYER_5_VARIABLES_CROSS_ADDITION,
    LAYER_4_CHANNELS_GATES_ADDITION,
    CHANNELS_FIRST_ADDITION,
    LAYER_3_CENTERS_ADDITION,
    CONDITIONING_THEORY_ADDITION,
    SUPPORT_OF_PROCESS_ADDITION,
    LAYER_2_PROFILE_DEFINITION_ADDITION,
    LAYER_1_TYPE_STRATEGY_AUTHORITY_ADDITION,
    STRATEGY_AND_AUTHORITY_IN_ACTION_ADDITION,
    LAYERED_READING_PROTOCOL_ADDITION,
    GLOBAL_CONFIG_ANALYSIS_ADDITION,
    CHANNELS_DATA_ADDITION,
    GENE_KEYS_TRAITS_ADDITION,
    CONTINUING_EDUCATION_ADDITION,
    TOC_PROMPT_SECTIONS,
  ].join('');
...
if (require.main === module) {
    const layers = [
          ...
          ['CHANNELS_FIRST_ADDITION (new)', CHANNELS_FIRST_ADDITION],
